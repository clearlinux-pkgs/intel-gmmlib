...
Version  : 20.2.3
Release  : 19
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-20.2.3/gmmlib-20.2.3.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-20.2.3/gmmlib-20.2.3.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-20.2.3
cd %{_builddir}/gmmlib-intel-gmmlib-20.2.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595864910
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gmmlib-intel-gmmlib-20.2.3/LICENSE.md %{buildroot}/usr/share/package-licenses/intel-gmmlib/8b0e9f012620e45a7426bb39ecc64a0cd2f876b1
pushd clr-build
%make_install
popd
