...
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.3.4/gmmlib-22.3.4.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.3.4
cd %{_builddir}/gmmlib-intel-gmmlib-22.3.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677004085
mkdir -p clr-build
pushd clr-build
