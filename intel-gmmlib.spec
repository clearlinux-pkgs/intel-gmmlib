...
Version  : 21.3.2
Release  : 31
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-21.3.2/gmmlib-21.3.2.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-21.3.2/gmmlib-21.3.2.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-21.3.2
cd %{_builddir}/gmmlib-intel-gmmlib-21.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635115805
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gmmlib-intel-gmmlib-21.3.2/LICENSE.md %{buildroot}/usr/share/package-licenses/intel-gmmlib/d20436278232615063a7e8362183ec1b307addc9
pushd clr-build
%make_install
popd
