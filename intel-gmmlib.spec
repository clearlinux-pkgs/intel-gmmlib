...
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.2.2/gmmlib-19.2.2.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-19.2.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1561086378
mkdir -p clr-build
pushd clr-build
