...
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.1.7/gmmlib-22.1.7.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.1.7
cd %{_builddir}/gmmlib-intel-gmmlib-22.1.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661353111
mkdir -p clr-build
pushd clr-build
