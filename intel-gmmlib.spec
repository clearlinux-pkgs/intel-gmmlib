...
Version  : 22.3.10
Release  : 53
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.3.10/gmmlib-22.3.10.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.3.10/gmmlib-22.3.10.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.3.10
cd %{_builddir}/gmmlib-intel-gmmlib-22.3.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692052555
mkdir -p clr-build
pushd clr-build
