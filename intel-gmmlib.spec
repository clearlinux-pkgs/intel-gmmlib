...
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.3.2/gmmlib-19.3.2.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-19.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568915315
mkdir -p clr-build
pushd clr-build
