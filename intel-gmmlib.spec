...
Version  : 19.1.2
Release  : 8
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.1.2/gmmlib-19.1.2.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.1.2/gmmlib-19.1.2.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-19.1.2
...
export LANG=C
export SOURCE_DATE_EPOCH=1555167664
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libigdgmm.so.9
/usr/lib64/libigdgmm.so.9.0.PATCH_VERSION
