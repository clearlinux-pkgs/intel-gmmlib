...
Version  : 22.3.13
Release  : 55
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.3.13/gmmlib-22.3.13.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.3.13/gmmlib-22.3.13.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.3.13
cd %{_builddir}/gmmlib-intel-gmmlib-22.3.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700154239
mkdir -p clr-build
pushd clr-build
