...
Version  : 19.1.1
Release  : 7
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.1.1.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.1.1.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-19.1.1
...
export LANG=C
export SOURCE_DATE_EPOCH=1553561304
mkdir -p clr-build
pushd clr-build
