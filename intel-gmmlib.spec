...
Version  : 22.4.1
Release  : 57
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.4.1/gmmlib-22.4.1.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.4.1/gmmlib-22.4.1.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.4.1
cd %{_builddir}/gmmlib-intel-gmmlib-22.4.1
pushd ..
cp -a gmmlib-intel-gmmlib-22.4.1 buildavx2
popd
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libigdgmm.so.12.4.0
/usr/lib64/libigdgmm.so.12
/usr/lib64/libigdgmm.so.12.4.0
