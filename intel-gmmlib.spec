...
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.3.3/gmmlib-22.3.3.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.3.3
cd %{_builddir}/gmmlib-intel-gmmlib-22.3.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673038972
mkdir -p clr-build
pushd clr-build
