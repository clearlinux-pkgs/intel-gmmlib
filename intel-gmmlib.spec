...
Version  : 19.2.3
Release  : 11
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.2.3/gmmlib-19.2.3.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.2.3/gmmlib-19.2.3.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-19.2.3
...
export LANG=C
export SOURCE_DATE_EPOCH=1561602551
mkdir -p clr-build
pushd clr-build
