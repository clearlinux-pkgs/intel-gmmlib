...
Version  : 22.5.2
Release  : 84
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.5.2/gmmlib-22.5.2.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.5.2/gmmlib-22.5.2.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.5.2
cd %{_builddir}/gmmlib-intel-gmmlib-22.5.2
pushd ..
cp -a gmmlib-intel-gmmlib-22.5.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725979880
mkdir -p clr-build
pushd clr-build
