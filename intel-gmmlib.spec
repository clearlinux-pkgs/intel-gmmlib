...
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.2.0/gmmlib-22.2.0.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.2.0
cd %{_builddir}/gmmlib-intel-gmmlib-22.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663625338
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/glibc-hwcaps/x86-64-v3/libigdgmm.so.12.2.0
/usr/lib64/libigdgmm.so.12
/usr/lib64/libigdgmm.so.12.2.0
