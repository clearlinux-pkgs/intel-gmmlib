...
Version  : 21.3.1
Release  : 30
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-21.3.1/gmmlib-21.3.1.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-21.3.1/gmmlib-21.3.1.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-21.3.1
cd %{_builddir}/gmmlib-intel-gmmlib-21.3.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631891639
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gmmlib-intel-gmmlib-21.3.1/LICENSE.md %{buildroot}/usr/share/package-licenses/intel-gmmlib/d20436278232615063a7e8362183ec1b307addc9
pushd clr-build
%make_install
popd
