...
Version  : 22.7.2
Release  : 91
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.7.2/gmmlib-22.7.2.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.7.2/gmmlib-22.7.2.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.7.2
cd %{_builddir}/gmmlib-intel-gmmlib-22.7.2
pushd ..
cp -a gmmlib-intel-gmmlib-22.7.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746473085
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libigdgmm.so.12.7.0
/usr/lib64/libigdgmm.so.12
/usr/lib64/libigdgmm.so.12.7.0
