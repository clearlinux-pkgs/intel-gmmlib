...
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.7.0/gmmlib-22.7.0.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.7.0
cd %{_builddir}/gmmlib-intel-gmmlib-22.7.0
pushd ..
cp -a gmmlib-intel-gmmlib-22.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1741273881
mkdir -p clr-build
pushd clr-build
