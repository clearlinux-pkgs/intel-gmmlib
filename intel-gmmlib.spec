...
Version  : 22.3.18
Release  : 56
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.3.18/gmmlib-22.3.18.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.3.18/gmmlib-22.3.18.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.3.18
cd %{_builddir}/gmmlib-intel-gmmlib-22.3.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710189130
mkdir -p clr-build
pushd clr-build
