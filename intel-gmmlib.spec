...
Version  : 20.2.2
Release  : 18
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-20.2.2/gmmlib-20.2.2.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-20.2.2/gmmlib-20.2.2.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-20.2.2
cd %{_builddir}/gmmlib-intel-gmmlib-20.2.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592937327
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gmmlib-intel-gmmlib-20.2.2/LICENSE.md %{buildroot}/usr/share/package-licenses/intel-gmmlib/8b0e9f012620e45a7426bb39ecc64a0cd2f876b1
pushd clr-build
%make_install
popd
