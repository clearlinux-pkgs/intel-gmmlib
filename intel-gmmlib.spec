...
Version  : 19.2.4
Release  : 12
URL      : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.2.4/gmmlib-19.2.4.tar.gz
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-19.2.4/gmmlib-19.2.4.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-19.2.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567202436
mkdir -p clr-build
pushd clr-build
