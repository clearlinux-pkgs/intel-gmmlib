...
Source0  : https://github.com/intel/gmmlib/archive/intel-gmmlib-22.3.12/gmmlib-22.3.12.tar.gz
...
%prep
%setup -q -n gmmlib-intel-gmmlib-22.3.12
cd %{_builddir}/gmmlib-intel-gmmlib-22.3.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1695766283
mkdir -p clr-build
pushd clr-build
