...
%prep
%setup -q -n gmmlib-intel-gmmlib-21.3.5
cd %{_builddir}/gmmlib-intel-gmmlib-21.3.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640225359
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/gmmlib-intel-gmmlib-21.3.5/LICENSE.md %{buildroot}/usr/share/package-licenses/intel-gmmlib/d20436278232615063a7e8362183ec1b307addc9
pushd clr-build
%make_install
popd
